import{c as ct,e as dt,g as mt,i as ut,j as gt}from"./chunk-AAMEGHVX.js";import{A as rt,B as lt,C as at,D as re,E as pt,a as Ge,b as H,c as _,d as X,e as Le,f as Ke,g as Oe,h as Ae,i as We,j as je,k as Ue,l as qe,m as Z,n as ee,p as Je,q as He,r as Xe,s as Ze,t as et,u as tt,v as it,y as ot,z as nt}from"./chunk-FZ3YVUZA.js";import{f as oe,g as ne}from"./chunk-XOLJM4SV.js";import"./chunk-S35HUXPS.js";import{a as ze,c as Qe,d as Ye,e as ie,g as st}from"./chunk-FMILLHP6.js";import{f as De,ga as Y,ja as Be,ka as N,l as de,ma as J,oa as te}from"./chunk-Y6Z3Q5YN.js";import{$a as O,$b as y,Ab as p,Ac as Ve,Bb as Te,Bc as Re,Cb as Ne,Cc as T,Db as ce,Eb as Ie,Fb as W,Gb as j,Kb as d,Mb as U,Na as c,Ob as S,Pb as E,Qb as M,Rb as R,Sa as Ce,Sb as q,Tb as Fe,X as ve,Y as I,Ya as P,Z as F,Za as $,a as we,ab as xe,bb as m,ca as b,g as K,hc as z,ib as A,ic as ke,jb as s,ka as g,la as f,lb as Pe,mb as V,na as k,nb as Se,ob as Ee,sb as r,tb as l,ua as B,ub as C,xb as Me,xc as $e,yb as h,zb as w,zc as Q}from"./chunk-2WHKZRHE.js";var Et=({dt:e})=>`
.p-floatlabel {
    display: block;
    position: relative;
}
...
`,Mt={root:({instance:e,props:i})=>["p-floatlabel",{"p-floatlabel-over":i.variant==="over","p-floatlabel-on":i.variant==="on","p-floatlabel-in":i.variant==="in"}]},ft=(()=>{class e extends J{name="floatlabel";theme=Et;classes=Mt;static \u0275fac=(()=>{let t;return function(o){return(t||(t=k(e)))(o||e)}})();static \u0275prov=I({token:e,factory:e.\u0275fac})}return e})();var Tt=["*"],me=(()=>{class e extends te{_componentStyle=b(ft);variant="over";static \u0275fac=(()=>{let t;return function(o){return(t||(t=k(e)))(o||e)}})();static \u0275cmp=P({type:e,selectors:[["p-floatlabel"],["p-floatLabel"],["p-float-label"]],hostVars:8,hostBindings:function(n,o){n&2&&Pe("p-floatlabel",!0)("p-floatlabel-over",o.variant==="over")("p-floatlabel-on",o.variant==="on")("p-floatlabel-in",o.variant==="in")},inputs:{variant:"variant"},features:[R([ft]),O],ngContentSelectors:Tt,decls:1,vars:0,template:function(n,o){n&1&&(Te(),Ne(0))},dependencies:[T,N],encapsulation:2,changeDetection:0})}return e})(),ht=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275mod=$({type:e});static \u0275inj=F({imports:[me,N,N]})}return e})();var u=[];for(let e=0;e<256;++e)u.push((e+256).toString(16).slice(1));function yt(e,i=0){return(u[e[i+0]]+u[e[i+1]]+u[e[i+2]]+u[e[i+3]]+"-"+u[e[i+4]]+u[e[i+5]]+"-"+u[e[i+6]]+u[e[i+7]]+"-"+u[e[i+8]]+u[e[i+9]]+"-"+u[e[i+10]]+u[e[i+11]]+u[e[i+12]]+u[e[i+13]]+u[e[i+14]]+u[e[i+15]]).toLowerCase()}var ue,It=new Uint8Array(16);function ge(){if(!ue){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");ue=crypto.getRandomValues.bind(crypto)}return ue(It)}var Ft=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),fe={randomUUID:Ft};function kt(e,i,t){if(fe.randomUUID&&!i&&!e)return fe.randomUUID();e=e||{};let n=e.random??e.rng?.()??ge();if(n.length<16)throw new Error("Random bytes length must be >= 16");if(n[6]=n[6]&15|64,n[8]=n[8]&63|128,i){if(t=t||0,t<0||t+16>i.length)throw new RangeError(`UUID byte range ${t}:${t+15} is out of buffer bounds`);for(let o=0;o<16;++o)i[t+o]=n[o];return i}return yt(n)}var L=kt;function he(e=!1){return{id:L(),isPrimaryKey:e,name:"NewProperty",propertyMethods:"{get; init;}",type:"string",isCollection:!1}}var ye=(x=>(x.Guid="Guid",x.string="string",x.bool="bool",x.int="int",x.short="short",x.decimal="decimal",x.DateTime="DateTime",x.TimeOnly="TimeOnly",x.DateOnly="DateOnly",x))(ye||{});function bt(e){return JSON.stringify(e)}function le(){return/^[^_ -][A-z][^_ -]*$/}function _e(){return/^[^ -][A-z][^ -]*$/}var $t=({dt:e})=>`
.p-toggleswitch {
